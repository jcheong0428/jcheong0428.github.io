...
great opportunity learn something new and meet new friends. But there are many
summer schools that neuroscience researchers can attend and choosing which one
to attend can be a difficult choice.

Here I outline my experience in two of the summer schools that I had the previlege
...
I would recommend MIND if you want to focus more on learning advanced methods
...
and interpersonal aspects. I would recommend going to Neurohackademy in
the first few years of grad school and then going to MIND in later years.**
...
hosted at the University of Washington eScience Institute in Seattle. Participants come from a wide
...
but in summary the first week was devoted to introductory tutorials & lectures
and the second week was reserved for a hackathon.

Lectures in the first week covered introductions to common programming languages
including Python, R, and Matlab. Each language was covered from basic concepts to using it
for more advanced analyses. For example, tutorials in R included basic data munging
...
on open and reproducible science, and thus covers using tools such as containers.
...
neural network and how they come together to form more complicated models such as CNNs with an
...
shortcut options using [Vue.js](https://vuejs.org/) and [Firebase](https://firebase.google.com/).
...
for research articles. Whenever I read academic papers, I often wanted to have discussions
about the paper as well as know about what others thought of the paper, the history
of the paper, and any updates regarding the paper. All of this information is
surprisingly difficult to get and that is why I think PaperWiki could be a useful
tool for researchers as well as students. Currently, once can search for articles
and create a Wikipedia-like article for each paper in markdown. There is currently
a Disqus commenting board which I hope to replace with a reddit-like board in the future.

Overall, Neurohackademy is a great opportunity where you can learn a ton about programming,
neuroimaging research, and open science tools and meet core developers of the Python scientific computing ecosystem such as numpy, sklearn, nipype, and Jupyter. If you are interested in
...
still packs in a tons great lectures and tutorials. The hackathon at MIND begins
...
didn't really get intense until the second week of hackathons.

There is a day devoted for learning about open science tools such as
...
As the focus is on learning new anlytic tools and methods, the hackathons
also seem more aimed towards applying these methods to your own or public data (in contrast
...
have some experience in programming that wants to focus on learning and applying
new methods in a short amount of time. You get to interact with instructors with
various expertise so it's a great opportunity to learn those new methods from the
experts who use them. You can check out the MIND lecture videos [here](https://www.youtube.com/channel/UCFiU9ZsUybQPq14MgvZJZSQ/videos).
...
If you are early on in your graduate program or if you would like to get a
